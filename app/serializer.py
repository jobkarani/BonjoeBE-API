...
class PhoneSerializer(serializers.ModelSerializer):
    category_name = serializers.CharField(source='phonecategory.name')
    category_slug = serializers.CharField(source='phonecategory.slug')
    category_id = serializers.IntegerField(source='phonecategory.id')
    class Meta:
        model = Phones
        fields = ['id', 'name', 'slug', 'image', 'image2', 'image3', 'description','new_price', 'old_price', 'is_available','category_name','category_slug','category_id']
